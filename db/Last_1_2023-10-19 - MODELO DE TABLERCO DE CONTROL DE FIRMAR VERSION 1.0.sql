...
CREATE TABLE `pki_x509_ac_autorizadas` (
  ...
  `s_tipo` varchar(10) COMMENT ' tipo de certificado (OCSP, INTERMEDIO, RAIZ)',
  `s_url` varchar(255),
...
/*ALTER TABLE `pki_documento_firmantes` ADD FOREIGN KEY (`pki_transaccion`) REFERENCES `pki_transaccion` (`n_id_transaccion`);*/
